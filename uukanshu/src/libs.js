...
function attr(doc, selector, atrribute_name) {
    var el = $.Q(doc, selector);
    if (el && typeof el.attr === 'function') {
        return el.attr(atrribute_name)
    }
    return null;
}
...
function createCoverImgFromBookid(bookid){
    //https://image.uukanshu.cc/25/25950/25950s.jpg
    return `https://image.uukanshu.cc/${bookid.slice(0, bookid.length - 3)}/${bookid}/${bookid}s.jpg`
}
